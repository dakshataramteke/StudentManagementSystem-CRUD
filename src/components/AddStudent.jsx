...
const AddStudent = () => {
      ...
      if (file) {
        ...
        const Submit =(e)=>{
          ...
          for (const key in students) {
            ...
            axios.post('http://localhost:8081/addstudent',formData, {
              headers: {
    ...
    return (
      ...
      <div>
        <div className=" container-fluid StudentForm px-4">
        ...
        <div className="col-12 col-md-6">
            ...
            <div className="col-12 col-md-6">
                ...
                <input
                    ...
                    className="form-control"
                    id="lname"
                    name="lastname" // Match this with the state property
                    value={students.lastname} // Bind to state
                    onChange={handleChange} // Use the generic handler
                />
            </div>
        </div>
       ...
       <div className="row">
        ...
        <div className="row">
          <div className="col-12 col-md-4">
            ...
            <select className="form-select" aria-label="Default select example"     name="class"
